...
if($_SERVER['REQUEST_METHOD'] == "POST") { 
	...
	$val = true;
		...
		if($val) {
            ...
            $sqlchange = "UPDATE `korisnik` SET `tip_id`='2'WHERE username = '$username'";
...
<div class="box">
	<form action="#" method="POST" class="firstform">
		<span class="text-center">Unesite username korisnika čiju rolu želite da promenite</span>
	<div>
        <br>
    <label>Username: <input type="text" name="username"></label>	
		<span class='error'><?php echo $usernameError ?></span>	
	</div>
		<input type="submit" class="btn" value="Promeni">
</form>	
</div>
</body>
