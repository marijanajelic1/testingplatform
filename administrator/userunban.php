...
if($_SERVER['REQUEST_METHOD'] == "POST") { 
	...
	$val = true;
		...
		if($val) {
            ...
            $sqlchange = "UPDATE `korisnik` SET `banovan`=0 WHERE username = '$username'";
...
<div class="box">
	<form action="#" method="POST" class="firstform">
		<span class="text-center">Unesite username korisnika kog zelite da unbanujete</span>
	<div>
		<input type="text" name="username">
		<span class='error'><?php echo $usernameError ?></span>
		<label>Username</label>		
	</div>
		<input type="submit" class="btn" value="Unbanuj korisnika">
</form>	
</div>
</body>
